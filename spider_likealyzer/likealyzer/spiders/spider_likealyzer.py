...
class KeyholeSpider(CrawlSpider):
    ...
    def parse(self, response):
        ...
        likealyzer['coverMetric'] = response.xpath('//span[contains(text(),"Frontpage")]/following::span[1]/text()').extract()
        likealyzer['aboutMetric'] = response.xpath('//span[contains(text(),"About")]/following::span[1]/text()').extract_first()
        likealyzer['activityMetric'] = response.xpath('//span[contains(text(),"Activity")]/following::span[1]/text()').extract()
        likealyzer['responseMetric'] = response.xpath('//span[contains(text(),"Response")]/following::span[1]/text()').extract()
        likealyzer['compromiseMetric'] = response.xpath('//span[contains(text(),"Engagement")]/following::span[1]/span/text()').extract()
